//global is anything baout preload
...
function setup() {
  ...
  gameOverImage = createSprite(300, 100, 50,50);
  gameOverImage.addImage(gameOver);
  gameOverImage.scale = 0.5;
  
  restartImage = createSprite(300, 135, 50, 50);
...
function draw() {
 ...
 // console.log(message);
  ...
  trex.debug = false;
  trex.setCollider("rectangle", 0, 0, 100, 65);
  
  //offsetis0,0(+sign on debug)
  ...
  if(gameState === PLAY){
    ...
    //126+127 comment to make normal again and uncomment 129
